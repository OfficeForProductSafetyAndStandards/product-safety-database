  ...
  class InvestigationProductsController < ApplicationController
    ...
    def unlink
      ...
      if @remove_product_form.remove_product
        RemoveProductFromNotification.call!(investigation: @investigation, investigation_product: @investigation_product, user: current_user, reason: @remove_product_form.reason)
