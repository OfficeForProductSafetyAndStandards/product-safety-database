module InvestigationProducts
  class BatchNumbersController < ApplicationController
    ...
    def update
      ...
      ChangeBatchNumber.call!(investigation_product: @investigation_product, batch_number: batch_number_params[:batch_number], user: current_user, source: UserSource.new(user: current_user))
