  ...
  def call
    ...
    ActiveRecord::Base.transaction do
      ...
      products = new_products.map do |new_product|
        ...
        AddProductToNotification.call!(notification: bulk_products_upload.investigation, product:, user:, skip_email: true)
      ...
      existing_products.each do |existing_product|
        context = AddProductToNotification.call!(notification: bulk_products_upload.investigation, product: existing_product[:product], user:, skip_email: true)
