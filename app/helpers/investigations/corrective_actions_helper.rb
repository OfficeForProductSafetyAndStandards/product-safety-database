module Investigations
  ...
  private
    ...
    def online_recall_information_text_for(online_recall_information, has_online_recall_information:)
      return link_to("#{online_recall_information} (opens in new tab)", online_recall_information_url(online_recall_information), rel: "noopener", target: "_blank") if has_online_recall_information&.inquiry&.has_online_recall_information_yes?
