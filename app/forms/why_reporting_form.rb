class WhyReportingForm
  ...
  def self.from(investigation)
    new(reported_reason_unsafe: (reported_reason.unsafe? || reported_reason.unsafe_and_non_compliant?),
        reported_reason_non_compliant: (investigation.non_compliant? || reported_reason.unsafe_and_non_compliant? ),
