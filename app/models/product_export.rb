class ProductExport < ApplicationRecord
  ...
  def export(products)
    Axlsx::Package.new do |p|
      ...
      add_product_info_worksheet(book, products)

      add_test_results_worksheet(book, products)

      add_risk_assessments_worksheet(book, products)
...
private
  ...
  def add_product_info_worksheet(book, products)
  ...
  def add_test_results_worksheet(book, products)
  ...
  def add_corrective_actions_worksheet(book, products)
  ...
  def add_risk_assessments_worksheet(book, products)
