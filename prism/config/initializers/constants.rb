...
NORMAL_RISK_CREATE_STEPS = %i[
  choose_hazard_type add_a_harm_scenario_and_probability_of_harm determine_severity_of_harm determine_severity_of_harm_casualties add_uncertainty_and_sensitivity_analysis check_your_harm_scenario confirm_overall_product_risk
].freeze
