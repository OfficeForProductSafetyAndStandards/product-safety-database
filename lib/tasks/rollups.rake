namespace :rollups do
  ...
  task generate: :environment do
    ...
    User.rollup("Active users", column: :last_activity_at_approx, interval: :day)
    User.rollup("Active users", column: :last_activity_at_approx, interval: :month)
    User.rollup("Active users", column: :last_activity_at_approx, interval: :year)
