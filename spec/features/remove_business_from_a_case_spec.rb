...
RSpec.feature "Remove a business from a notification", :with_stubbed_mailer do
  ...
  scenario "when the business is attached to supporting information" do
    ...
    expect(page).to have_css(".hmcts-banner__message", text: "Cannot remove the business from the notification because it's associated with following supporting information ")
