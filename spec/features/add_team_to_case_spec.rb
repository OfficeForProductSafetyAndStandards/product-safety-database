...
RSpec.feature "Adding a team to a case", :with_stubbed_elasticsearch, :with_stubbed_antivirus, :with_stubbed_mailer, :with_stubbed_notify do
  ...
  scenario "when signed in as a read-only user" do
