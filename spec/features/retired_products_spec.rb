...
RSpec.feature "Retired products", :with_opensearch, :with_stubbed_mailer, type: :feature do
  ...
  context "when signed in as an opss user" do
    ...
    scenario "the user can view a live product" do
      ...
      expect(page).not_to have_content("Warning This product record is retired.")
      ...
      expect(page).to have_link "Create a new case"
    end
    ...
    scenario "the user can view a retired product" do
      ...
      expect(page).to have_content("Warning This product record is retired.")
      ...
      expect(page).not_to have_link "Create a new case"
    end
