RSpec.feature "Case actions", :with_stubbed_antivirus, :with_stubbed_mailer, type: :feature do
  ...
  let(:investigation_5) { create :allegation, :with_business, :with_products, :with_document, creator: user, is_closed: true, date_closed: Date.new(2021, 1, 1) }
  ...
  context "when a super user" do
    ...
    scenario "with a closed case as a super user" do
      visit investigation_path(investigation_5)
      expect_to_be_on_case_page(case_id: investigation_5.pretty_id)
