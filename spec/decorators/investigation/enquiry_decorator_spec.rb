  ...
  describe "#source_details_summary_list" do
    ...
    context "when date_received is nil" do
      ...
      it "does not display the Received date" do
        expect(source_details_summary_list).not_to summarise("Received date")
      end
    ...
    context "when received_type is nil" do
      ...
      it "does not display the Received by" do
        expect(source_details_summary_list).not_to summarise("Received by")
      end
    ...
    context "when both date_received and received_type are nil" do
      ...
      it "does not display the Received date and Received by" do
        expect(source_details_summary_list).not_to summarise("Received date")
        expect(source_details_summary_list).not_to summarise("Received by")
      end
