...
RSpec.describe "Managing documents attached to a case, product or business", :with_stubbed_mailer, :with_stubbed_opensearch, :with_errors_rendered, type: :request do
