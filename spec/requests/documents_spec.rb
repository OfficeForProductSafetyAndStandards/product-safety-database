...
RSpec.describe "Managing documents attached to a case, product or business", :with_stubbed_mailer, :with_stubbed_elasticsearch, :with_errors_rendered, type: :request do
