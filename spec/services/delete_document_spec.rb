...
RSpec.describe DeleteDocument, :with_stubbed_elasticsearch, :with_test_queue_adapter do
    ...
    context "with required parameters" do
      ...
      context "when the parent is an Investigation" do
        ...
        def expected_email_body(name)
          "Document attached to the #{investigation.case_type.upcase_first} was removed by #{name}."
        end
