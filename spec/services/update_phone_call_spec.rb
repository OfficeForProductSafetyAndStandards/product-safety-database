...
RSpec.describe UpdatePhoneCall, :with_stubbed_antivirus, :with_stubbed_mailer do
        ...
        context "with a team email" do
          it "notifies the relevant users", :with_test_queue_adapter do
            expect { result }.to have_enqueued_mail(NotifyMailer, :notification_updated).with(
              ...
              "Phone call details updated on the notification by #{user_same_team.decorate.display_name(viewer: user_same_team)}.",
