...
RSpec.describe ChangeCaseOwner, :with_test_queue_adapter do
  ...
  subject(:result) { described_class.call(investigation: investigation, user: user, owner: new_owner, rationale: rationale) }
  ...
  describe ".call" do
    context "without search index", :with_stubbed_elasticsearch do
      ...
      context "with no investigation parameter" do
        subject(:result) { described_class.call(owner: new_owner, user: user) }
      ...
      context "with no user parameter" do
        subject(:result) { described_class.call(owner: new_owner, investigation: investigation) }
