...
gem "govuk-design-system-rails", git: "https://github.com/UKGovernmentBEIS/govuk-design-system-rails", branch: "component-modernisation-batch-2", require: "govuk_design_system"
