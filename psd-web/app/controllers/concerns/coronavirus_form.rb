module CoronavirusForm
  ...
  def assigns_coronavirus_related_from_form(investigation, coronavirus_form_params)
    form = coronavirus_related_form(coronavirus_form_params)
  ...
  def coronavirus_related_form(coronavirus_form_params)
