...
Rails.application.routes.draw do
  ...
  devise_for :users, path: "", path_names: { sign_in: "sign-in", two_factor_authentication: "two-factor" }, controllers: { sessions: "users/sessions", passwords: "users/passwords", two_factor_authentication: "users/two_factor_authentication" } do
