...
ActiveRecord::Schema.define(version: 2019_11_19_151907) do
  ...
  create_table "organisations", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.string "path"
    t.datetime "updated_at", null: false
    t.index %w[path], name: "index_organisations_on_path"
  end
  ...
  create_table "teams", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index %w[name], name: "index_teams_on_name"
    t.index %w[organisation_id], name: "index_teams_on_organisation_id"
    t.index %w[path], name: "index_teams_on_path"
  end
  ...
  create_table "users", id: :uuid, default: nil, force: :cascade do |t|
    ...
    t.index %w[name], name: "index_users_on_name"
    t.index %w[organisation_id], name: "index_users_on_organisation_id"
  end
