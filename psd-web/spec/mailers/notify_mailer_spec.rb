...
RSpec.describe NotifyMailer, :with_stubbed_elasticsearch do
  ...
  describe "#team_added_to_case_email" do
    subject(:mail) { described_class.team_added_to_case_email(edit_accesses_collaboration, to_email: "test@example.com") }
    ...
    let(:edit_accesses_collaboration) { create(:edit_accesses_collaboration, message: message, added_by_user: added_by_user, collaborator: collaborator_team) }
      ...
      context "when the user is on another team" do
        it "sets the personalisation" do
          expect(mail.govuk_notify_personalisation).to eql(
            ...
            investigation_url: investigation_url(edit_accesses_collaboration.investigation)
          )
        end
      end
  ...
  describe "#team_deleted_from_case_email" do
    ...
    let(:edit_accesses_collaboration) { create(:edit_accesses_collaboration, collaborator: team_to_be_deleted) }
    let(:investigation) { edit_accesses_collaboration.investigation }
