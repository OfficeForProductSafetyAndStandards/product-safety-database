...
RSpec.describe SendSMS do
  describe ".send_otp_code" do
    ...
    let(:expected_payload) do
      { phone_number: phone_number, template_id: described_class::TEMPLATES[:send_otp_code], personalisation: { code: code } }
    end
    ...
    it "sends the otp code" do
      ...
      described_class.send_otp_code(mobile_number: phone_number, code: code)
    end
  end
end
