...
10.times do
  ...
  AddRiskAssessmentToCase.call!(risk_assessment_params.merge(investigation: investigation_product.investigation, user:, assessed_by_team_id: Team.find_by(name: "Seed Team").id))
